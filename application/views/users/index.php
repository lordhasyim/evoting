	...
	<div class="col-lg-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-bar-chart-o fa-fw"></i> Manajemen User
					...
					<?php foreach ($users as $user):?>
						<tr>
							...
							<td><?php echo ($user->active) ? anchor("users/deactivate/".$user->id, lang('index_active_link'),
									"class='btn btn-primary'") : anchor("users/activate/". $user->id, lang('index_inactive_link'));?></td>
							<td><?php echo anchor("users/edit/".$user->id, 'Edit', "class='btn btn-primary'") ;?></td>
						</tr>
					<?php endforeach;?>
				</table>
				<p><?php echo anchor('users/create', lang('index_create_user_link'), "class='btn btn-success'")?> | <?php echo anchor('groups/create', lang('index_create_group_link'),"class='btn btn-success'")?></p>
			</div>
			<!-- /.panel-heading -->
