                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <?php echo lang('create_group_name_label', 'group_name', "class='col-sm-4 control-label'"); ?>
                        ...
                        <div class="form-group">
                            <?php echo lang('create_group_desc_label', 'description', "class='col-sm-4 control-label'"); ?>
