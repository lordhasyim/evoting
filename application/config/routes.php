...
$route['event'] = 'Event';
$route['voting-result'] = 'VotingResult/result';
$route['voting-result/(:num)'] = 'VotingResult/index/$1';
$route['voting-result/data/(:num)'] = 'VotingResult/data/$1';
$route['voter-percentage'] = 'Dashboard/voterPercentage';
$route['dashboard/graph'] = 'Dashboard/graph';
$route['dashboard/booth/(:num)'] = 'Dashboard/booth/$1';